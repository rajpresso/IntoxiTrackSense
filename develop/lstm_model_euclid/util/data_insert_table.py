...
#     def insert_data(self, folder_path, version, major_category, sub_category):
...
#                 print(f"file_name {file_name} major_category {major_category}")
...
#     def import_data(self, version, category ):
#         """
